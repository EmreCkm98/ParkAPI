...
namespace ParkyWeb.Controllers
{
    public class HomeController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            { 
                NationalParkList=await _nationalParkRepo.GetAllAsync(SD.NationalParkAPIPath,HttpContext.Session.GetString("JWToken")),
        ...
        public async Task<IActionResult> Logout()
        {
            ...
            HttpContext.Session.SetString("JWToken", "");//delete session
